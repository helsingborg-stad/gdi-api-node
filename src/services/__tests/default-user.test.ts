...
const createAuthorizationServiceForTest = () => createAuthorizationService('shared secret', () => DefaultUser)
...
describe('authorization-service', () => {
	...
	it('tryGetUserFromJwt(<empty>) => <DEFAULT>', () => {
		...
		expect(s.tryGetUserFromJwt(null)).toMatchObject(DefaultUser)
		expect(s.tryGetUserFromJwt(undefined)).toMatchObject(DefaultUser)
	})
